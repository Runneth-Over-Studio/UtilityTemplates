...
public sealed class RestoreTask : FrostingTask<BuildContext>
{
    public override void Run(BuildContext context)
    {
        ...
        foreach (KeyValuePair<string, IEnumerable<ReleaseProject>> projectsByApp in context.ReleaseProjectsByAppNames)
        {
            foreach (ReleaseProject project in projectsByApp.Value)
            {
